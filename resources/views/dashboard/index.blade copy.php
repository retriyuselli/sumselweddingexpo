            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        @endif
                        <div>
                            <h1 class="text-xl sm:text-2xl md:text-3xl font-bold mb-1">Welcome back, {{ auth()->user()->name }}!</h1>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl border border-neutral-200 p-4 sm:p-6">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-xs px-2 py-1 bg-green-50 text-green-600 rounded-full font-medium">Active</span>
                        </div>
                        <h3 class="text-xs text-neutral-600 mb-1">Account Status</h3>
                        <p class="text-lg sm:text-xl font-bold text-neutral-900">{{ ucfirst(auth()->user()->role->value ?? 'User') }}</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-neutral-200 p-4 sm:p-6">
                        ...
                        <h3 class="text-xs text-neutral-600 mb-1">Registrations</h3>
                        <p class="text-lg sm:text-xl font-bold text-neutral-900">0</p>
                        <p class="text-xs text-neutral-500 mt-1">Total submissions</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-neutral-200 p-4 sm:p-6">
                        ...
                        <h3 class="text-xs text-neutral-600 mb-1">Events Attended</h3>
                        <p class="text-lg sm:text-xl font-bold text-neutral-900">0</p>
                        <p class="text-xs text-neutral-500 mt-1">Wedding Expo events</p>
                    </div>
                ...
                <div class="grid lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-xl border border-neutral-200 p-4 sm:p-6">
                            ...
                            <div class="grid sm:grid-cols-2 gap-3">
                                <a href="/exhibitor" class="flex items-center gap-3 p-4 border border-neutral-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition group">
                                    <div class="w-10 h-10 rounded-lg bg-blue-50 group-hover:bg-blue-100 flex items-center justify-center">
                                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 class="text-xs sm:text-sm font-semibold text-neutral-900">{{ ($registeredAsExhibitor ?? false) ? 'Terdaftar' : 'Register as Exhibitor' }}</h3>
                                        <p class="text-xs text-neutral-600">{{ ($registeredAsExhibitor ?? false) ? 'Terima kasih telah mendaftar' : 'Submit your application' }}</p>
                                    </div>
                                </a>

                                <a href="/jadwal" class="flex items-center gap-3 p-4 border border-neutral-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition group">
                                    <div class="w-10 h-10 rounded-lg bg-purple-50 group-hover:bg-purple-100 flex items-center justify-center">
                                        <svg class="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                        </svg>
                                    </div>
                                ...
                                <a href="/partners" class="flex items-center gap-3 p-4 border border-neutral-200 rounded-lg hover:border-rose-300 hover:bg-rose-50 transition group">
                                    <div class="w-10 h-10 rounded-lg bg-rose-50 group-hover:bg-rose-100 flex items-center justify-center">
                                        <svg class="w-5 h-5 text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="/blog" class="flex items-center gap-3 p-4 border border-neutral-200 rounded-lg hover:border-amber-300 hover:bg-amber-50 transition group">
                                    <div class="w-10 h-10 rounded-lg bg-amber-50 group-hover:bg-amber-100 flex items-center justify-center">
                                        <svg class="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white rounded-xl border border-neutral-200 p-4 sm:p-6">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="/jadwal" class="text-xs sm:text-sm text-blue-600 hover:text-blue-700 font-medium">View All</a>
                            </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex gap-4 p-4 bg-linear-to-r from-rose-50 to-pink-50 rounded-lg">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-xs sm:text-sm font-semibold text-neutral-900 mb-1">Sumsel Wedding Expo 2026</h3>
                                        <p class="text-xs text-neutral-600 mb-2">15-17 Februari 2026 • Palembang Icon</p>
                                        <span class="inline-block text-xs px-2 py-1 bg-rose-100 text-rose-700 rounded-full font-medium">3 Days Event</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center justify-between text-xs">
                                        ...
                                        <span class="font-medium text-neutral-900">{{ ucfirst($user->role->value ?? 'User') }}</span>
                                    </div>
                                    <div class="flex items-center justify-between text-xs">
                                        <span class="text-neutral-600">Status</span>
                                        <span class="px-2 py-1 bg-green-50 text-green-600 rounded-full font-medium">Active</span>
                                    </div>
                                    <div class="flex items-center justify-between text-xs">
                                ...
                                <div class="pt-4 space-y-2">
                                    <a href="/profile" class="block w-full px-4 py-2 text-center text-xs sm:text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-medium">
                                        Edit Profile
                                    </a>
                                    <a href="/settings" class="block w-full px-4 py-2 text-center text-xs sm:text-sm border border-neutral-300 text-neutral-700 rounded-lg hover:bg-neutral-50 transition font-medium">
                                        Settings
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="bg-linear-to-br from-blue-600 to-indigo-700 rounded-xl p-4 sm:p-6 text-white">
                            ...
                            <a href="https://wa.me/6281234567890" target="_blank" class="inline-flex items-center gap-2 text-xs font-medium hover:underline">
                                Contact Support
