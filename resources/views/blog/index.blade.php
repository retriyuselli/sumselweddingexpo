    ...
    <main class="min-h-screen">
        ...
        <section class="py-12 bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center bg-linear-to-r from-rose-50 to-pink-50 rounded-2xl overflow-hidden">
                    <div class="order-2 md:order-1 p-6 sm:p-8">
                        <span class="inline-block px-3 py-1 bg-rose-600 text-white text-xs font-semibold rounded-full mb-3 sm:mb-4">Featured</span>
                        ...
                        <a href="{{ route('blog.show', $featuredBlog->slug) }}" class="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-rose-600 text-white rounded-lg font-semibold hover:bg-rose-700 transition text-sm sm:text-base">
                            Baca Selengkapnya
        ...
        <section class="py-12 bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    <a href="{{ route('blog.category', $category->slug) }}" class="block p-6 rounded-xl border border-neutral-200 bg-linear-to-br from-rose-50 to-pink-50 hover:shadow-lg transition">
        ...
        <section class="py-12 bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" id="blog-grid">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    <!-- Article -->
                    <article class="blog-item bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow duration-300" data-category="{{ $blog->category->slug }}">
                        <div class="relative overflow-hidden">
                            ...
                            <span class="absolute top-4 left-4 px-3 py-1 bg-{{ $blog->category_color ?: 'purple' }}-600 text-white text-xs font-semibold rounded-full">
                                {{ $blog->category->name }}
                            </span>
                        </div>
        ...
        <section class="py-16 bg-linear-to-r from-rose-600 to-pink-600 text-white">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                <div class="mb-4 sm:mb-6">
                    <svg class="w-16 h-16 sm:w-20 sm:h-20 mx-auto text-white opacity-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
