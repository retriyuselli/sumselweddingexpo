        ...
        <div class="py-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-3 text-sm">
                    <span class="inline-block px-3 py-1 bg-{{ $article['category_color'] }}-600 text-white text-xs font-semibold rounded-full">{{ $article['category'] }}</span>
                </div>
                ...
                <div class="my-6 rounded-xl overflow-hidden">
                    <img src="{{ $article['image'] }}" 
                         alt="{{ $article['title'] }}" class="w-full h-auto">
                </div>
                @endif
                ...
                <style>
                    ...
                    .blog-content h1 { font-size: 1.5rem; font-weight: 700; color: #111827; margin: 1.5rem 0 1rem; }
                    .blog-content h2 { font-size: 1.25rem; font-weight: 700; color: #111827; margin: 1.5rem 0 1rem; }
                    .blog-content h3 { font-size: 1.125rem; font-weight: 700; color: #111827; margin: 1.25rem 0 0.75rem; }
                    .blog-content h4 { font-size: 1rem; font-weight: 700; color: #111827; margin: 1rem 0 0.5rem; }
                    .blog-content p { margin-bottom: 1rem; line-height: 1.75; }
                    .blog-content a { color: #f43f5e; text-decoration: none; }
                    .blog-content a:hover { text-decoration: underline; }
                    .blog-content strong, .blog-content b { font-weight: 600; color: #111827; }
                    ...
                    /* Nested Lists */
                    .blog-content ul ul, .blog-content ol ul { list-style-type: circle; }
                    .blog-content ol ol, .blog-content ul ol { list-style-type: lower-alpha; }
