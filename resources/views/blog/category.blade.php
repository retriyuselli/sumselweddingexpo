    ...
    <main class="min-h-screen">
                    ...
                    @foreach ($categories as $cat)
                        <a href="{{ route('blog.category', $cat->slug) }}"
                            ...
                            @if ($cat->blogs_count > 0)
                                <span
                                    class="inline-flex items-center justify-center w-5 h-5 text-xs {{ $cat->id === $category->id ? 'bg-rose-700 text-white' : 'bg-gray-100 text-gray-600 group-hover:bg-rose-100 group-hover:text-rose-600' }} rounded-full transition">
                                    {{ $cat->blogs_count }}
                                </span>
                            @endif
                        </a>
                    ...
                    @forelse($blogs as $blog)
                        ...
                        <article
                            ...
                            <div class="relative overflow-hidden">
                                ...
                                <span
                                    class="absolute top-4 left-4 px-3 py-1 bg-rose-600 text-white text-xs font-semibold rounded-full">
                                    {{ $blog->category->name }}
                                </span>
                            </div>
        ...
        <section class="py-16 bg-linear-to-r from-rose-600 to-pink-600 text-white">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                ...
                <a href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20konsultasi%20pernikahan" target="_blank"
