                    ...
                    <div class="p-6">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-sm text-neutral-700">Silakan verifikasi email Anda untuk mengakses fitur utama. Jika belum menerima email, kirim ulang verifikasi.</p>
                            </div>
                            <button type="button" @click="open=false" class="text-neutral-500 hover:text-neutral-700" aria-label="Tutup">&times;</button>
                        </div>
                        <div class="mt-6 flex items-center justify-end gap-3">
                            <form method="POST" action="{{ route('verification.send') }}">
                                @csrf
                                <button type="submit" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-rose-600 text-white hover:bg-rose-700">Kirim ulang verifikasi</button>
                            </form>
                            <button type="button" @click="open=false" class="px-4 py-2 rounded-lg border border-neutral-200 text-neutral-700 hover:bg-neutral-50">Nanti</button>
                        </div>
                    </div>
                </div>
            </div>
