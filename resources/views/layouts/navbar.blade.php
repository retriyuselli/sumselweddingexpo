...
<header class="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur border-b border-neutral-200">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 grid grid-cols-3 items-center md:flex md:items-center md:justify-between">
        <button id="mobile-menu-button" class="md:hidden justify-self-start p-2 rounded-lg hover:bg-neutral-100" aria-label="Toggle menu">
        ...
        <div class="flex items-center gap-3 justify-self-end">
            <div class="relative dropdown-hover">
                <a href="{{ route('cart') }}" class="relative p-2 rounded-lg hover:bg-neutral-100"
                    ...
                    <div class="relative md:hidden" id="mobile-profile">
                        <button id="mobile-profile-button" class="p-2 rounded-lg hover:bg-neutral-100" aria-label="Profile">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                <path fill-rule="evenodd" d="M12 2.25a5.25 5.25 0 100 10.5 5.25 5.25 0 000-10.5zm-7.5 18a7.5 7.5 0 0115 0v.75a.75.75 0 01-.75.75h-13.5a.75.75 0 01-.75-.75v-.75z" clip-rule="evenodd" />
                            </svg>
                        </button>
                        <div id="mobile-profile-menu" class="absolute right-0 mt-2 w-56 rounded-lg border border-neutral-200 bg-white shadow-lg py-1 opacity-0 invisible transition-all duration-200">
                            ...
                            <a href="{{ route('appointments.index') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-50">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
