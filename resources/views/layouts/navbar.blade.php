        ...
        <div class="flex items-center gap-3">
            <div class="relative dropdown-hover">
                <a href="{{ route('cart') }}" class="relative p-2 rounded-lg hover:bg-neutral-100"
                    ...
                    <span id="cart-badge"
                        class="absolute -top-1 -right-1 sm:top-7 sm:-left-4 z-10 bg-red-600 text-white text-[10px] rounded-full w-4 h-4 flex items-center justify-center">0</span>
                </a>
                <div
            ...
            <button id="mobile-menu-button" class="md:hidden p-2 rounded-lg hover:bg-neutral-100"
