...
@section('content')
    ...
    <section
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div
                    class="bg-white/10 backdrop-blur-lg rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300 hover:scale-105 border border-white/20">
    ...
    <section id="sponsor" class="py-16 sm:py-20 bg-neutral-50">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="mt-3 text-neutral-600 max-w-2xl mx-auto">Terima kasih kepada partner resmi dan exhibitor yang
                    mendukung acara ini</p>
            </div>
            ...
            <div class="relative flex items-center justify-center gap-4">
                ...
                <button id="scrollLeft"
                    class="shrink-0 flex items-center justify-center w-10 h-10 rounded-full bg-rose-600 text-white hover:bg-rose-700 transition-all duration-300 hover:scale-110 shadow-lg">
                ...
                <div id="sponsorScroll" class="flex-1 flex overflow-x-auto snap-x snap-mandatory gap-2 scroll-smooth"
                    style="scrollbar-width: none;">
                    @forelse($sponsors as $sponsor)
                        @if ($sponsor->logo && Storage::disk('public')->exists($sponsor->logo))
                            <div class="shrink-0 w-40 snap-center">
                                <div
                                    class="relative w-full h-32 transition-all duration-300 hover:scale-110 flex items-center justify-center overflow-hidden">
            ...
            <div class="mt-12 text-center">
                <a href="/exhibitor"
                    class="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-rose-600 text-white hover:bg-rose-700 transition-all hover:scale-105 shadow-lg hover:shadow-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-5 h-5">
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <div
                    ...
                    <span
                        class="text-sm font-medium bg-linear-to-r from-purple-600 to-pink-600 text-transparent bg-clip-text">Social
                        Media</span>
                </div>
                <h2 class="text-2xl sm:text-4xl font-bold text-neutral-900 mb-4">Follow Us on Instagram</h2>
                <p class="text-neutral-600 max-w-2xl mx-auto">Ikuti kami untuk mendapatkan update terbaru, behind the
                    scenes, dan inspirasi pernikahan</p>
            ...
            <div class="flex justify-center">
                <blockquote class="instagram-media" data-instgrm-permalink="https://www.instagram.com/sumselweddingexpo/"
    ...
    <section id="tiket"
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-lg border border-white/20 mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
